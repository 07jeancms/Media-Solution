...
function movieTableController($scope, $http, dataManager, messageService) {
  ...
  $scope.addMovie = function() {
    ...
    then(function(data, status) {
      messageService.setMessage("La pelicula " + movieNameCreateInput + " ha sido creada correctamente.");
  ...
  $scope.editMovie = function() {
    ...
    $http.post(url, movieData).
    then(function(data, status) {
        messageService.setMessage("La pelicula " + $scope.actualMovie.pelicula + " se ha actualizado correctamente.");
        setTimeout(function() { window.location.reload(true); }, 2000);
    })
  }
  //-----------------------------------------------------------------------------------------------------------------------------------//
  ...
  $scope.deleteMovie = function(pActualMovie) {
    ...
    $http.post(url, movieData).
    then(function(data, status) {
        messageService.setMessage("La pelicula " + pActualMovie.pelicula + " se ha eliminado correctamente.");
        setTimeout(function() { window.location.reload(true); }, 2000);
    })
  }
